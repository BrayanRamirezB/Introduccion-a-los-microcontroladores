...
; 0000 001F indice++;
	INC  R5
; 0000 0020 if (indice == 10) indice = 0;
	LDI  R30,LOW(10)
	CP   R30,R5
	BRNE _0x3
	CLR  R5
...
; 0000 0027 if (indice == 0) indice = 9;
	TST  R5
	BRNE _0x4
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0028 else indice--;
	RJMP _0x5
_0x4:
	DEC  R5
; 0000 0029 }
...
; 0000 007B // INT1: On
; 0000 007C // INT1 Mode: Low level
; 0000 007D // INT2: Off
; 0000 007E GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
; 0000 007F MCUCR=(0<<ISC11) | (0<<ISC10) | (1<<ISC01) | (1<<ISC00);
	LDI  R30,LOW(3)
	OUT  0x35,R30
...
; 0000 009A TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 009B 
; 0000 009C // Globally enable interrupts
; 0000 009D #asm("sei")
	SEI
; 0000 009E 
; 0000 009F while (1)
