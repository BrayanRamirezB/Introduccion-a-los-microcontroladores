...
_tabla7segmentos:
	...
	.DB  0x7F,0x6F,0x77,0x7C,0x39,0x5E,0x79,0x47
...
_0x3:
; 0000 0087 {
; 0000 0088 variable=PIND&0X0f;
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 0089 variable2=PINC&0x0f;
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 008A if(variable<16){
	LDI  R30,LOW(16)
	CP   R5,R30
	BRSH _0x6
; 0000 008B PORTB=tabla7segmentos[variable];
	MOV  R30,R5
	LDI  R31,0
	...
	OUT  0x18,R0
; 0000 008C }
; 0000 008D if(variable2<16){
_0x6:
	LDI  R30,LOW(16)
	CP   R4,R30
	BRSH _0x7
; 0000 008E PORTA=~tabla7segmentos[variable2];
	MOV  R30,R4
	LDI  R31,0
	SUBI R30,LOW(-_tabla7segmentos*2)
	SBCI R31,HIGH(-_tabla7segmentos*2)
