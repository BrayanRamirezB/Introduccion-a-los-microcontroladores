...
; 0000 0053 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0054 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
...
_0x6:
; 0000 00AB {
; 0000 00AC cn = read_adc(0)*500/255;
	LDI  R26,LOW(0)
	RCALL _read_adc
	LDI  R31,0
	LDI  R26,LOW(500)
	...
	RCALL __DIVW21
	MOV  R5,R30
; 0000 00AD actual = btn;
	CLT
	SBIC 0x10,0
	SET
	BLD  R2,2
; 0000 00AE 
; 0000 00AF //Boton de modo
; 0000 00B0 if (pasado == 1 && actual == 0) {
	SBRS R2,1
	RJMP _0xA
	SBRS R2,2
	RJMP _0xB
_0xA:
	RJMP _0x9
_0xB:
; 0000 00B1 isFahrenheit = ~isFahrenheit;
	LDI  R30,LOW(1)
	EOR  R2,R30
; 0000 00B2 delay_ms(20);
	LDI  R26,LOW(20)
	RCALL SUBOPT_0x0
; 0000 00B3 }
; 0000 00B4 
; 0000 00B5 if (pasado == 0 && actual == 1) {
_0x9:
	SBRC R2,1
	RJMP _0xD
	SBRC R2,2
...
; 0000 00B8 
; 0000 00B9 
; 0000 00BA if (isFahrenheit) {
_0xC:
	SBRS R2,0
	RJMP _0xF
; 0000 00BB intensidad = (9*cn/5) + 32;
	MOV  R30,R5
	LDI  R26,LOW(9)
	MUL  R30,R26
	MOVW R30,R0
	...
	SUBI R30,-LOW(32)
	MOV  R4,R30
; 0000 00BC centenas = intensidad/100;
	RJMP _0x36
; 0000 00BD decenas = (intensidad%100 - intensidad%10)/10;
; 0000 00BE unidades = intensidad%10;
; 0000 00BF 
; 0000 00C0 PORTB = tabla7segmentos[centenas];
; 0000 00C1 C0=0;
; 0000 00C2 C1=0;
; 0000 00C3 C2=1;
...
; 0000 00CB 
; 0000 00CC PORTB = tabla7segmentos[unidades];
; 0000 00CD C0=1;
; 0000 00CE C1=0;
; 0000 00CF C2=0;
...
; 0000 00D2 } else {
_0xF:
; 0000 00D3 intensidad = cn;
	MOV  R4,R5
; 0000 00D4 centenas = intensidad/100;
_0x36:
	MOV  R26,R4
	LDI  R27,0
	LDI  R30,LOW(100)
	...
	RCALL __DIVW21
	MOV  R9,R30
; 0000 00D5 decenas = (intensidad%100 - intensidad%10)/10;
	MOV  R26,R4
	CLR  R27
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	...
	RCALL __DIVW21
	MOV  R6,R30
; 0000 00D6 unidades = intensidad%10;
	RCALL SUBOPT_0x1
	MOV  R7,R30
; 0000 00D7 
; 0000 00D8 
; 0000 00D9 PORTB=tabla7segmentos[centenas];
	MOV  R30,R9
	RCALL SUBOPT_0x2
; 0000 00DA C0=0;
; 0000 00DB C1=0;
...
; 0000 00DD delay_ms(5);
	...
	RCALL SUBOPT_0x0
; 0000 00DE 
; 0000 00DF PORTB = tabla7segmentos[decenas];
	MOV  R30,R6
	RCALL SUBOPT_0x2
; 0000 00E0 C0=0;
; 0000 00E1 C1=1;
...
; 0000 00E2 C2=0;
	CBI  0x15,2
; 0000 00E3 delay_ms(5);
	LDI  R26,LOW(5)
	RCALL SUBOPT_0x0
; 0000 00E4 
; 0000 00E5 PORTB = tabla7segmentos[unidades];
	MOV  R30,R7
	LDI  R31,0
