...
; 0000 00AA cn=(read_adc(0)*50)/255;
	LDI  R26,LOW(0)
	RCALL _read_adc
	LDI  R26,LOW(50)
	MUL  R30,R26
...
; 0000 00AC unidades=cn%10;
	...
	MOV  R7,R30
; 0000 00AD 
; 0000 00AE PORTB=tab7seg[decenas];
	MOV  R30,R4
	RCALL SUBOPT_0x0
; 0000 00AF C0=0;
	CBI  0x15,0
...
; 0000 00B2 
; 0000 00B3 
; 0000 00B4 PORTB=tab7seg[unidades];
	MOV  R30,R7
	RCALL SUBOPT_0x0
; 0000 00B5 C0=1;
	SBI  0x15,0
