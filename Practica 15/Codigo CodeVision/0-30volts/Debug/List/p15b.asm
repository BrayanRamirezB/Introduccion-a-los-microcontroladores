...
; 0000 009E ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(129)
	OUT  0x6,R30
; 0000 009F SFIOR=(1<<ADHSM) | (0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(16)
	OUT  0x30,R30
; 0000 00A0 
...
; 0000 00AC cn=(read_adc(0)*300)/255;
	LDI  R26,LOW(0)
	RCALL _read_adc
	LDI  R31,0
	LDI  R26,LOW(300)
...
; 0000 00AD centenas=cn/100;
	...
	RCALL __DIVW21
	MOV  R4,R30
; 0000 00AE decenas=(cn%100 - cn%10)/10;
	MOV  R26,R5
	CLR  R27
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	...
	RCALL __DIVW21
	MOV  R7,R30
; 0000 00AF unidades=cn%10;
	RCALL SUBOPT_0x0
	MOV  R6,R30
; 0000 00B0 
; 0000 00B1 PORTB=tab7seg[centenas];
	MOV  R30,R4
	RCALL SUBOPT_0x1
; 0000 00B2 C0=0;
; 0000 00B3 C1=0;
...
; 0000 00B4 C2=1;
	SBI  0x15,2
; 0000 00B5 delay_ms(20);
	RCALL SUBOPT_0x2
; 0000 00B6 
; 0000 00B7 PORTB=tab7seg[decenas];
	MOV  R30,R7
	RCALL SUBOPT_0x1
; 0000 00B8 C0=0;
; 0000 00B9 C1=1;
...
; 0000 00BC 
; 0000 00BD 
; 0000 00BE PORTB=tab7seg[unidades];
	MOV  R30,R6
	LDI  R31,0
	SUBI R30,LOW(-_tab7seg*2)
	SBCI R31,HIGH(-_tab7seg*2)
	LPM  R0,Z
	OUT  0x18,R0
; 0000 00BF C0=1;
	SBI  0x15,0
