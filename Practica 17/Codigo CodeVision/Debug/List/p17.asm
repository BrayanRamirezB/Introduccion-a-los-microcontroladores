...
_0x6:
	...
	.DB  0x7F,0x0,0x7F,0x7F,0x7F,0x0,0x36,0x7F
	.DB  0x7F,0x0,0x36,0x36,0x7F,0x0,0x36,0x36
	.DB  0x36,0x0,0x36,0x36,0x36,0x49,0x36,0x36
	.DB  0x36,0x49,0x7F,0x36,0x36,0x49,0x7F,0x0
	.DB  0x36,0x49,0x7F,0x0,0x76,0x49,0x7F,0x0
	.DB  0x76,0x76,0x7F,0x0,0x76,0x76,0x76,0x0
	.DB  0x76,0x76,0x76,0x9,0x76,0x76,0x76,0x9
	.DB  0x7F,0x76,0x76,0x9,0x7F,0x0,0x76,0x9
	.DB  0x7F,0x0,0x76,0x9,0x7F,0x0,0x76,0x76
	.DB  0x7F,0x0,0x76,0x76,0x76,0x0,0x76,0x76
	.DB  0x76,0x0,0x76,0x76,0x76,0x0,0x7F,0x76
	.DB  0x76,0x0,0x7F,0x7C,0x76,0x0,0x7F,0x7C
	.DB  0x7B,0x0,0x7F,0x7C,0x7B,0x7,0x7F,0x7C
	.DB  0x7B,0x7,0x7B,0x7C,0x7B,0x7,0x7B,0x7C
	.DB  0x7B,0x7,0x7B,0x7C,0x7F,0x7,0x7B,0x7C
	.DB  0x7F,0x0,0x7B,0x7C,0x7F,0x0,0x76,0x7C
	.DB  0x7F,0x0,0x76,0x76,0x7F,0x0,0x76,0x76
	.DB  0x76,0x0,0x76,0x76,0x76,0x0,0x76,0x76
	.DB  0x76,0x0,0x7F,0x76,0x76,0x0,0x7F,0x0
	.DB  0x76,0x0,0x7F,0x0,0x7D,0x0,0x7F,0x0
	.DB  0x7D,0x7B,0x7F,0x0,0x7D,0x7B,0x77,0x0
	.DB  0x7D,0x7B,0x77,0x0,0x7D,0x7B,0x77,0x0
	.DB  0x7F,0x7B,0x77,0x0,0x7F,0x7F,0x77,0x0
	.DB  0x7F,0x7F,0x7F,0x0,0x7F,0x7F,0x7F,0x7F
	.DB  0x7F,0x7F,0x7F,0x7F,0x7F,0x7F,0x7F,0x7F
	.DB  0x7F,0x0,0x7F,0x7F,0x7F,0x0,0x76,0x7F
	.DB  0x7F,0x0,0x76,0x76,0x7F,0x0,0x76,0x76
	.DB  0x76,0x0,0x76,0x76,0x76,0x9
...
; 0000 00EE filas = ~modoAct1[indice];
	MOV  R30,R6
	LDI  R31,0
	SUBI R30,LOW(-_modoAct1)
	SBCI R31,HIGH(-_modoAct1)
	LD   R30,Z
	COM  R30
	RCALL SUBOPT_0x0
...
; 0000 010A filas = modoNumero[numero][indice];
	...
	MUL  R30,R26
	MOVW R30,R0
	SUBI R30,LOW(-_modoNumero)
	SBCI R31,HIGH(-_modoNumero)
	RCALL SUBOPT_0x2
; 0000 010B repetir++;
...
; 0000 0118 filas = modoNombre[letra][indice];
	...
	MUL  R30,R26
	MOVW R30,R0
	SUBI R30,LOW(-_modoNombre)
	SBCI R31,HIGH(-_modoNombre)
	RCALL SUBOPT_0x2
; 0000 0119 repetir++;
...
SUBOPT_0x1:
	...
	MUL  R30,R26
	MOVW R30,R0
	SUBI R30,LOW(-_modo2_3)
	SBCI R31,HIGH(-_modo2_3)
	MOVW R26,R30
	CLR  R30
	ADD  R26,R6
	ADC  R27,R30
