...
_0x3:
; 0000 0095 {
; 0000 0096 //BOTON Izquierda
; 0000 0097 if (botonp == 0)
	SBRC R2,0
	RJMP _0x6
; 0000 0098 botona = 0;
	CLT
...
_0x27:
	BLD  R2,4
; 0000 009B if ((botonp == 1)&&(botona == 0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,4
	RJMP _0xA
...
_0xA:
; 0000 009C {
; 0000 009D PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 009E delay_ms(25);
	RCALL SUBOPT_0x2
; 0000 009F PORTA = 0x00;
	RCALL SUBOPT_0x0
; 0000 00A0 delay_ms(475);
	LDI  R26,LOW(475)
	LDI  R27,HIGH(475)
	RCALL _delay_ms
; 0000 00A1 }
...
; 0000 00A5 
; 0000 00A6 
; 0000 00A7 //BOTON Derecha
; 0000 00A8 if (botonp1 == 0)
	SBRC R2,1
	RJMP _0xE
; 0000 00A9 botonb = 0;
	CLT
...
_0x28:
	BLD  R2,5
; 0000 00AC if ((botonp1 == 1)&&(botonb == 0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,1
	RJMP _0x11
	SBRS R2,5
	RJMP _0x12
...
_0x12:
; 0000 00AD {
; 0000 00AE PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 00AF delay_ms(50);
	LDI  R26,LOW(50)
	RCALL SUBOPT_0x3
; 0000 00B0 PORTA = 0x00;
; 0000 00B1 delay_ms(450);
	LDI  R26,LOW(450)
	LDI  R27,HIGH(450)
	RCALL _delay_ms
; 0000 00B2 }
; 0000 00B3 if ((botonp1 == 0)&&(botonb == 1)) //hubo cambio de flanco de 0 a 1
_0x10:
	SBRC R2,1
	RJMP _0x14
	SBRC R2,5
...
_0x14:
	RJMP _0x13
_0x15:
; 0000 00B4 delay_ms(25);
	RCALL SUBOPT_0x2
; 0000 00B5 botonp1 = botonb;
_0x13:
	BST  R2,5
	BLD  R2,1
; 0000 00B6 
; 0000 00B7 
; 0000 00B8 //BOTON Arriba
; 0000 00B9 if (botonp2 == 0)
	SBRC R2,2
	RJMP _0x16
; 0000 00BA botonc = 0;
	CLT
...
_0x29:
	BLD  R2,6
; 0000 00BD if ((botonp2 == 1)&&(botonc == 0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,2
	RJMP _0x19
	SBRS R2,6
	RJMP _0x1A
...
_0x1A:
; 0000 00BE {
; 0000 00BF PORTA = 0xff;
	RCALL SUBOPT_0x1
; 0000 00C0 delay_ms(75);
	LDI  R26,LOW(75)
	RCALL SUBOPT_0x3
; 0000 00C1 PORTA = 0x00;
; 0000 00C2 delay_ms(425);
	LDI  R26,LOW(425)
	LDI  R27,HIGH(425)
	RCALL _delay_ms
; 0000 00C3 }
; 0000 00C4 if ((botonp2 == 0)&&(botonc == 1)) //hubo cambio de flanco de 0 a 1
_0x18:
	SBRC R2,2
	RJMP _0x1C
	SBRC R2,6
...
_0x1C:
	RJMP _0x1B
_0x1D:
; 0000 00C5 delay_ms(25);
	RCALL SUBOPT_0x2
; 0000 00C6 botonp2 = botonc;
_0x1B:
	BST  R2,6
	BLD  R2,2
; 0000 00C7 
; 0000 00C8 
; 0000 00C9 //BOTON Abajo
; 0000 00CA if (botonp3 == 0)
	SBRC R2,3
	RJMP _0x1E
; 0000 00CB botond = 0;
	CLT
...
_0x2A:
	BLD  R2,7
; 0000 00CE if ((botonp3 == 1)&&(botond == 0)) //hubo cambio de flanco de 1 a 0
	SBRS R2,3
	RJMP _0x21
	SBRS R2,7
	RJMP _0x22
...
; 0000 00D3 delay_ms(400);
	LDI  R26,LOW(400)
	LDI  R27,HIGH(400)
	RCALL _delay_ms
; 0000 00D4 }
; 0000 00D5 if ((botonp3 == 0)&&(botond == 1)) //hubo cambio de flanco de 0 a 1
_0x20:
	SBRC R2,3
	RJMP _0x24
	SBRC R2,7
...
_0x24:
	RJMP _0x23
_0x25:
; 0000 00D6 delay_ms(25);
	RCALL SUBOPT_0x2
; 0000 00D7 botonp3 = botond;
_0x23:
	BST  R2,7
	BLD  R2,3
; 0000 00D8 
...
; 0000 00DA /*
; 0000 00DB if(IZQ == 0) {
; 0000 00DC PORTA = 0xff;
; 0000 00DD delay_ms(25);
; 0000 00DE PORTA = 0x00;
; 0000 00DF delay_ms(475);
; 0000 00E0 } else if(DER == 0) {
; 0000 00E1 PORTA = 0xff;
; 0000 00E2 delay_ms(50);
; 0000 00E3 PORTA = 0x00;
; 0000 00E4 delay_ms(450);
; 0000 00E5 } else if(ARRIBA == 0) {
; 0000 00E6 PORTA = 0xff;
; 0000 00E7 delay_ms(75);
; 0000 00E8 PORTA = 0x00;
; 0000 00E9 delay_ms(425);
; 0000 00EA } else if(ABAJO == 0) {
; 0000 00EB PORTA = 0xff;
; 0000 00EC delay_ms(100);
; 0000 00ED PORTA = 0x00;
; 0000 00EE delay_ms(400);
; 0000 00EF }
; 0000 00F0 
; 0000 00F1 */
; 0000 00F2 }
