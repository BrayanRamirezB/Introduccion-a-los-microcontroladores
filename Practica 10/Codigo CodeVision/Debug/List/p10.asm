...
; 0000 0031 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0032 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(7)
	OUT  0x14,R30
; 0000 0033 // State: Bit7=T Bit6=T Bit5=P Bit4=P Bit3=P Bit2=0 Bit1=0 Bit0=0
; 0000 0034 PORTC=(0<<PORTC7) | (0<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	LDI  R30,LOW(56)
	OUT  0x15,R30
; 0000 0035 
...
_0x3:
; 0000 008A {
; 0000 008B //C0 A C2 son de salida y son para
; 0000 008C //Probar las 3 columnas
; 0000 008D //Se prueba la primera columna se envía 110
; 0000 008E PORTC=0b00111110;
	LDI  R30,LOW(62)
	RCALL SUBOPT_0x0
; 0000 008F //C3, C4 y C5 son las entradas del teclado
; 0000 0090 //Por eso se enmascaran con 00111000
; 0000 0091 lectura=PINC&0b00111000;
; 0000 0092 if (lectura==0b00110000)
	BRNE _0x6
; 0000 0093 tecla=7;
	LDI  R30,LOW(7)
	MOV  R5,R30
; 0000 0094 if (lectura==0b00101000)
_0x6:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0x7
; 0000 0095 tecla=8;
	LDI  R30,LOW(8)
	MOV  R5,R30
; 0000 0096 if (lectura==0b00011000)
_0x7:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0x8
; 0000 0097 tecla=9;
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 0098 //se prueba segunda columna se envía 101
; 0000 0099 PORTC=0b00111101;
_0x8:
	LDI  R30,LOW(61)
	RCALL SUBOPT_0x0
; 0000 009A //C3, C4 y C5 son las entradas del teclado
; 0000 009B //Por eso se enmascaran con 00111000
; 0000 009C lectura=PINC&0b00111000;
; 0000 009D if (lectura==0b00110000)
	BRNE _0x9
; 0000 009E tecla=4;
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 009F if (lectura==0b00101000)
_0x9:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xA
; 0000 00A0 tecla=5;
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 00A1 if (lectura==0b00011000)
_0xA:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xB
; 0000 00A2 tecla=6;
	LDI  R30,LOW(6)
	MOV  R5,R30
; 0000 00A3 //se prueba tercera columna se envía 011
; 0000 00A4 PORTC=0b00111011;
_0xB:
	LDI  R30,LOW(59)
	RCALL SUBOPT_0x0
; 0000 00A5 //C3, C4 y C5 son las entradas del teclado
; 0000 00A6 //Por eso se enmascaran con 00111000
; 0000 00A7 lectura=PINC&0b00111000;
; 0000 00A8 if (lectura==0b00110000)
	BRNE _0xC
; 0000 00A9 tecla=1;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 00AA if (lectura==0b00101000)
_0xC:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xD
; 0000 00AB tecla=2;
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 00AC if (lectura==0b00011000)
_0xD:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xE
; 0000 00AD tecla=3;
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 00AE PORTB=tabla7segmentos [tecla];
_0xE:
	MOV  R30,R5
	LDI  R31,0
